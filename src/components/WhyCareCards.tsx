  ...
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-4 relative">
        ...
        <div className="hidden lg:block absolute left-[25%] top-0 bottom-0 w-1 bg-g-dark -skew-x-12 z-0" />
        <div className="hidden lg:block absolute left-[50%] top-0 bottom-0 w-1 bg-g-dark -skew-x-12 z-0" />
        <div className="hidden lg:block absolute left-[75%] top-0 bottom-0 w-1 bg-g-dark -skew-x-12 z-0" />
        ...
        {cards.map((card, i) => {
          ...
          return (
            ...
            >
              <div className={`mb-8 inline-flex items-center justify-center w-24 h-24 rounded-full border-4 border-g-dark ${card.bg} shadow-brutal transition-transform group-hover:-translate-y-2`}>
                <Icon className="h-10 w-10 text-g-dark" strokeWidth={2.5} />
              </div>
